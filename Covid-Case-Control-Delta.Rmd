...
cases_age_0_to_17 <- age_0_to_17$total_cases[79]
age_18_to_49 <- delta %>%
  filter(demographic_value == "18-49")
tail(age_18_to_49)
cases_age_18_to_49 <- age_18_to_49$total_cases[79]
age_50_to_64 <- delta %>%
  filter(demographic_value == "50-64")
tail(age_50_to_64)
cases_age_50_to_64 <- age_50_to_64$total_cases[79]
age_65_up <- delta %>%
  filter(demographic_value == "65+")
tail(age_65_up)
cases_age_65_up <- age_65_up$total_cases[79]
```
...
cases_hawaiian_pacific_islander <- hawaiian_pacific_islander$total_cases[79]
multi_race <- delta %>%
...
tail(other)
tail(other, 1) 
cases_other <- other$total_cases[79]
tail(multi_race)
tail(multi_race, 1) 
cases_multi_race <- multi_race$total_cases[79]
hispanic_latino <- delta %>%
  filter(demographic_value == "Latino")
tail(hispanic_latino)
tail(hispanic_latino, 1) 
cases_hispanic_latino <- hispanic_latino$total_cases[79]
```
